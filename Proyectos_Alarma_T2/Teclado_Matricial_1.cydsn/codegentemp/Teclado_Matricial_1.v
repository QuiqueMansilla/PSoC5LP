// ======================================================================
// Teclado_Matricial_1.v generated from TopDesign.cysch
// 04/20/2018 at 10:41
...
module CharLCD_v2_20_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("9d2bfd99-cc28-4045-911e-f59244c613d0/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	wire [0:0] tmpOE__Data_A_LSB_net;
	wire [0:0] tmpFB_0__Data_A_LSB_net;
	wire [0:0] tmpIO_0__Data_A_LSB_net;
	wire [0:0] tmpINTERRUPT_0__Data_A_LSB_net;
	electrical [0:0] tmpSIOVREF__Data_A_LSB_net;
	...
	cy_psoc3_pins_v1_10
		...
		Data_A_LSB
		 (.oe(tmpOE__Data_A_LSB_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Data_A_LSB_net[0:0]}),
		  .io({tmpIO_0__Data_A_LSB_net[0:0]}),
		  .siovref(tmpSIOVREF__Data_A_LSB_net),
		  .interrupt({tmpINTERRUPT_0__Data_A_LSB_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Data_A_LSB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Data_B_net;
	wire [0:0] tmpFB_0__Data_B_net;
	wire [0:0] tmpIO_0__Data_B_net;
	wire [0:0] tmpINTERRUPT_0__Data_B_net;
	electrical [0:0] tmpSIOVREF__Data_B_net;

	cy_psoc3_pins_v1_10
		#(.id("7683042b-bcaf-445b-9f89-e0e75fa4beb0"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Data_B
		 (.oe(tmpOE__Data_B_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Data_B_net[0:0]}),
		  .io({tmpIO_0__Data_B_net[0:0]}),
		  .siovref(tmpSIOVREF__Data_B_net),
		  .interrupt({tmpINTERRUPT_0__Data_B_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Data_B_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Data_C_net;
	wire [0:0] tmpFB_0__Data_C_net;
	wire [0:0] tmpIO_0__Data_C_net;
	wire [0:0] tmpINTERRUPT_0__Data_C_net;
	electrical [0:0] tmpSIOVREF__Data_C_net;

	cy_psoc3_pins_v1_10
		#(.id("16146839-f9ad-488e-8458-f09596783704"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Data_C
		 (.oe(tmpOE__Data_C_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Data_C_net[0:0]}),
		  .io({tmpIO_0__Data_C_net[0:0]}),
		  .siovref(tmpSIOVREF__Data_C_net),
		  .interrupt({tmpINTERRUPT_0__Data_C_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Data_C_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Data_D_MSB_net;
	wire [0:0] tmpFB_0__Data_D_MSB_net;
	wire [0:0] tmpIO_0__Data_D_MSB_net;
	wire [0:0] tmpINTERRUPT_0__Data_D_MSB_net;
	electrical [0:0] tmpSIOVREF__Data_D_MSB_net;

	cy_psoc3_pins_v1_10
		#(.id("fb4128f5-8210-4c43-b0de-7697495452e5"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Data_D_MSB
		 (.oe(tmpOE__Data_D_MSB_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Data_D_MSB_net[0:0]}),
		  .io({tmpIO_0__Data_D_MSB_net[0:0]}),
		  .siovref(tmpSIOVREF__Data_D_MSB_net),
		  .interrupt({tmpINTERRUPT_0__Data_D_MSB_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Data_D_MSB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__DA_net;
	wire [0:0] tmpIO_0__DA_net;
	wire [0:0] tmpINTERRUPT_0__DA_net;
	electrical [0:0] tmpSIOVREF__DA_net;

	cy_psoc3_pins_v1_10
		#(.id("b1eb5cc4-bb74-4196-abfc-4ccc4aee453f"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		DA
		 (.oe(tmpOE__DA_net),
		  .y({1'b0}),
		  .fb({Net_6}),
		  .io({tmpIO_0__DA_net[0:0]}),
		  .siovref(tmpSIOVREF__DA_net),
		  .interrupt({tmpINTERRUPT_0__DA_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DA_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
