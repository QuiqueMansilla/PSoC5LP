// ======================================================================
// Robot1.v generated from TopDesign.cysch
// 01/31/2018 at 18:38
...
module top ;
    ...
    begin
        cy_srff_2 <= (Net_37 | Net_93) & ~Net_13;
    end
    assign Net_93 = cy_srff_2;
    // -- SRFF End --
    ...
    begin : LUT_1
        ...
        assign tmp__LUT_1_ins = {Net_93,Net_91};
        always @(tmp__LUT_1_ins)
        begin
            case (tmp__LUT_1_ins)
                2'b00 :  tmp__LUT_1_reg = 2'b00;
                2'b01 :  tmp__LUT_1_reg = 2'b11;
                2'b10 :  tmp__LUT_1_reg = 2'b01;
                2'b11 :  tmp__LUT_1_reg = 2'b00;
            endcase
        end
        assign {Net_96,Net_92} = tmp__LUT_1_reg;
    end
    // -- LUT LUT_1 end --
    ...
    always @(posedge Net_10)
    begin
        cy_srff_1 <= (Net_13 | Net_91) & ~Net_37;
    end
    assign Net_91 = cy_srff_1;
    // -- SRFF End --
	...
	cy_psoc3_pins_v1_10
		#(.id("69f00caa-11c4-4415-9960-0cb4c03a8bfd"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
